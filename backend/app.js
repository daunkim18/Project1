...
app.post('/sellbooks',(req,res)=>{
    let {email, phone, title, author} = req.body;
    console.log(req.body);
    poolconn.query('INSERT INTO sales_requests (email, phone_number, book_title, book_author) VALUES ($1,$2,$3,$4)', [email, phone, title, author], (error,results) => {
        if(error){
            res.sendStatus(500);
            return;
        }
